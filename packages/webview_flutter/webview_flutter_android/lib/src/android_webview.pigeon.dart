...
class WebViewHostApi {
  ...
  Future<void> setAccText(int arg_instanceId, String accText) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.WebViewHostApi.setAccText', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
    await channel.send(<Object?>[arg_instanceId, accText])
    as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
...
class WebViewClientHostApi {
  ...
  Future<void> create(
      int arg_instanceId, bool arg_shouldOverrideUrlLoading, Map<String, String>? arg_urlToFileMap) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.WebViewClientHostApi.create', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap = await channel
            .send(<Object?>[arg_instanceId, arg_shouldOverrideUrlLoading, arg_urlToFileMap])
        as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
