...
import 'package:whatfix_flutter_webview_android/webview_android_cookie_manager.dart';
import 'package:whatfix_flutter_webview_android/webview_surface_android.dart';
import 'package:whatfix_flutter_webview_platform_interface/webview_flutter_platform_interface.dart';
import 'package:whatfix_flutter_webview_wkwebview/webview_flutter_wkwebview.dart';
...
class WebView extends StatefulWidget {
  ...
  ///This adds a accessibility text for the native webView
  final String? accText;

  ///This map contains a map of html(and it's resources) url to the file path, it can be intercepted on native layer
