...
class WebViewClientHostApiImpl extends WebViewClientHostApi {
  ...
  /// Helper method to convert instances ids to objects.
  Future<void> createFromInstance(WebViewClient instance, Map<String, String>? urlToFileMap) async {
    if (instanceManager.getIdentifier(instance) == null) {
      final int identifier = instanceManager.addDartCreatedInstance(instance);
      return create(identifier, instance.shouldOverrideUrlLoading, urlToFileMap);
    }
  }
}
